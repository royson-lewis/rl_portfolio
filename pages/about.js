...
export default function About() {
  return (
    <main className={styles.about}>
      ...
      <p>I‘m a Full-stack Web Developer and UX/UI Designer, helping businesses and non-profits expand their capacity for impact. Working in product strategy, facilitation and prototyping with a solid background in interface design and front-end development.</p>
      <a href='https://storage.googleapis.com/royson-lewis.appspot.com/resume%20web%20dev.pdf' target='_blank'>
        <button>Download Resume</button>
      </a>
      <div>
        <h3>Say Hello!</h3>
        <section>
          <a href='https://twitter.com/lewisroysonj' target='_blank'>
          ...
          <a target='_blank' href='https://www.linkedin.com/in/lewisroysonj/'>
        ...
        <a style={{ color: "white" }} href='mailto:hello@roysonlewis.com' target='_blank'>
