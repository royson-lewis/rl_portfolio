...
export default function Header() {
  ...
  return (
      <>
        <header style={header.scrollingUp && !header.scrollingDown ? { opacity: 1, position: "fixed" } : !header.scrollingUp && header.scrollingDown ? { opacity: 0, position: "fixed" } : undefined} className={styles.headerMobile}>
        ...
        <header style={header.scrollingUp && !header.scrollingDown ? { opacity: 1, position: "fixed" } : !header.scrollingUp && header.scrollingDown ? { opacity: 0, position: "fixed" } : undefined} className={styles.headerDesktop}>
          <a href='/'>
            <div className={styles.logo}>
              <svg xmlns='http://www.w3.org/2000/svg' width='46' height='46.442' viewBox='0 0 46 46.442'>
                <g id='RoysonLewis_Logo' data-name='RoysonLewis Logo' transform='translate(-5883 -379.736)'>
