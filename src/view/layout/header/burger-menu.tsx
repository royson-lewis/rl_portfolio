...
export default function BurgerMenu(props: { open: boolean, toggleBurger: () => void }) {
  ...
  return <>
    <nav className={styles.burgerMenuOpen} style={nav.open ? { transform: "translateX(100vw)" } : undefined}>
    ...
    <div onClick={props.toggleBurger} style={nav.open ? { opacity: 1, pointerEvents: "all" } : undefined} className={styles.menuBackground} />
  </>;
}
