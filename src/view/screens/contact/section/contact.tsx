  ...
  return (
    <section style={{ marginBottom: "5rem" }} className={styles.contactSection}>
      ...
      <div style={service.modalOpen ? { display: "flex" } : { display: "none" }} className={styles.phoneModal}>
        <div>
          <input style={{ width: "fitContent", fontSize: "1.8rem" }} readOnly value='+91 9620062353' ref={copyRef} />
      ...
      <form id='form' onSubmit={submitHandler}>
        ...
        <label>
          Full Name*
          <input onChange={contactChangeHandler} value={contact.fullName} required name='fullName' autoComplete='name' />
        </label>
        <label>
          Email*
          <input onChange={contactChangeHandler} value={contact.email} required name='email' autoComplete='email' />
        </label>
        <label>
          Subject*
          <input onChange={contactChangeHandler} value={contact.subject} required name='subject' autoComplete='subject' />
        </label>
        <label>
          Message
