          ...
          <div className={styles['category-project']}>
            <div className={styles['project-images']}>
              <div className={styles['project-image-wrapper']}>
                <Image width="400" height="600" src="https://cdn.dribbble.com/userupload/2904447/file/original-848325509e0ad2b48f43dc5a8ca727c7.png?compress=1&resize=640x480" alt="project thumbnail" />
              </div>
              <div className={styles['project-image-wrapper']}>
                <Image width="400" height="600" src="https://cdn.dribbble.com/users/1544818/screenshots/17077305/media/fe24e9e9b8ff058af40afdfe1a4950d9.png?compress=1&resize=700x525&vertical=top" alt="project thumbnail" />
              </div>
            </div>
            <h4>Agency</h4>
          </div>
