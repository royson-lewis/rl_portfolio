  ...
  <>
    <section className={styles.serviceSection}>
      ...
      <section className={styles.frontEndSection}>
        ...
        <p>
          I develop custom designs to clean frontend code using technologies such as HTML,
          CSS/SASS/LESS, Javascript, React, Bootstrap, etc.
        </p>
      </section>
      <section className={styles.backEndSection}>
        ...
        <p>
          I develop servers using Node.js/Express along with databases such as MySQL, MongoDB to
          create fully functional web apps and websites.
        </p>
      </section>
    </section>
  </>
