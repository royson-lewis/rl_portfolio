...
export default function VamyouHeroArtDesktop() {
  return (
    <svg className={styles.essenceHeroArt} xmlns='http://www.w3.org/2000/svg' width='1920.029' height='854.854' viewBox='0 0 1920.029 854.854'>
